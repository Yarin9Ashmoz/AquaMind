...
class _DashboardScreenState extends State<DashboardScreen> {
                  ...
                  ? ListView(
                      ...
                      children: [
                        Padding(
                          ...
                          child: _buildWeatherCard(state),
                        ),
                        _buildEmptyState(),
                      ],
                    )
                  : _buildDashboardContent(displaySensors, state),
            ),
  ...
  Widget _buildDashboardContent(List<Sensor> sensors, DashboardState state) {
    ...
    return ListView(
      ...
      children: [
        // 📍 Weather Telemetry Summary Card
  ...
  // 📍 Weather Card Component UI Builder
  Widget _buildWeatherCard(DashboardState state) {
    final temp = state.currentTemp ?? 24.5;
    final wind = state.windSpeed ?? 12.0;
    final code = state.weatherCode ?? 0;
    final location = state.locationName ?? "Local Climate";
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Column(
            children: [
              Icon(_getWeatherIcon(code), size: 48, color: Colors.amberAccent),
              const SizedBox(height: 8),
              Row(
                children: [
